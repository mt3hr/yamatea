...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  PIDTargetColorBrightnessCalibrator *calibrator = new PIDTargetColorBrightnessCalibrator(BCM_BlackWhiteAverage);
  ...
  Predicate *predicateBanana = new WheelDistancePredicate(bananaDistance);
  ...
  Predicate *predicateOrange = new WheelDistancePredicate(orangeDistance);
  ...
  Predicate *predicateStarFruits = new WheelDistancePredicate(starFruitsDistance);
  ...
  Predicate *predicateCherry = new WheelDistancePredicate(cherryDistance);
  ...
  Predicate *predicateWaterMelon = new WheelDistancePredicate(waterMelonDistance);
  ...
  Predicate *predicateBokChoy = new WheelDistancePredicate(bokChoyDistance);
  ...
  Predicate *predicateDorian = new WheelDistancePredicate(dorianDistance);
  ...
  Predicate *predicateMelon = new WheelDistancePredicate(melonDistance);
  ...
  Predicate *predicateCucumber = new WheelDistancePredicate(cucumberDistance);
  ...
  Predicate *predicateStrawberry = new WheelDistancePredicate(strawberryDistance);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  */
  ...
  Predicate *predicateAsparagus = new WheelDistancePredicate(asparagusDistance);
  ...
  Predicate *predicateRadish = new WheelDistancePredicate(radishDistance);
  ...
  Predicate *predicateCabbage = new WheelDistancePredicate(cabbageDistance);
...
#define SonarStarter
  ...
  Predicate *predicate0 = new WheelDistancePredicate(distance);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  */
  ...
  Predicate *predicateCarrot = new WheelDistancePredicate(carrotDistance);
  ...
  */
  ...
  Predicate *predicatePeach = new WheelDistancePredicate(peachDistance);
  ...
  */
  ...
  Predicate *predicateLemon = new WheelDistancePredicate(lemonDistance);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
...

  {
    ...
    */
    ...
    Predicate *predicatePman = new WheelDistancePredicate(pmanDistance);
    ...
    */
    ...
    PIDTracerV2 *carrotPIDTracer = new PIDTracerV2(RIGHT_TRACE, pwm, kp, ki, kd, dt, r);
    // Predicate *predicateCarrot = new WheelDistancePredicate(carrotDistance );
    Predicate *predicateCarrot = new ANDPredicate(new WheelDistancePredicate(carrotDistance), new FacingRobotUseWheelPredicate(angle));
    commandExecutor->addCommand(carrotPIDTracer, predicateCarrot, GET_VARIABLE_NAME(carrotPIDTracer));
    calibrator->addPIDTracer(carrotPIDTracer);
    ...
    {
      predicateOrange = new WheelDistancePredicate(orangeDistance);
    }
    calibrator->addPIDTracer(orangePIDTracer);
    commandExecutor->addCommand(orangePIDTracer, predicateOrange, GET_VARIABLE_NAME(orangePIDTracer));
    ...
    angle = 24;
    CurvatureWalkerCommandAndPredicate *starFuitsWalker = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
    Predicate *predicateStarFruits = new WheelDistancePredicate(starFruitsDistance);
    ...
    {
      predicateWaterMelon = new WheelDistancePredicate(waterMelonDistance);
    }
    calibrator->addPIDTracer(waterMelonPIDTracer);
    commandExecutor->addCommand(waterMelonPIDTracer, predicateWaterMelon, GET_VARIABLE_NAME(waterMelonPIDTracer));
    ...
    radius = 23.5;
    theta = -360; // 多めにしないと動かんのか？
    CurvatureWalkerCommandAndPredicate *bokChoyWalker = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
    Predicate *predicateBokChoy = new WheelDistancePredicate(bokChoyDistance);
    ...
    Predicate *predicateHassaku = new WheelDistancePredicate(hassakuDistance);
    ...
    Predicate *predicatenuts = new WheelDistancePredicate(nutsDistance);
...
#ifdef GoalSanekataPIDMode2_Stable1
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  // カラーセンサの乗ったアームの角度を調節する
  ResetArmAngle *resetArmAngle = new ResetArmAngle();
...

  {
    ...
    */
    ...
    Predicate *predicateKiwi = new WheelDistancePredicate(kiwiDistance);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  WheelDistancePredicate *walker1Predicate = new WheelDistancePredicate(distance);
  ...
  WheelDistancePredicate *walker2Predicate = new WheelDistancePredicate(distance);
  ...
  WheelDistancePredicate *walker3Predicate = new WheelDistancePredicate(distance);
  ...
  r = 13.5;
  theta = -95;
  CurvatureWalkerCommandAndPredicate *curvatureWalkerCommandAndPredicate1 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  WheelDistancePredicate *walker4Predicate = new WheelDistancePredicate(distance );
  ...
  */
  ...
  WheelDistancePredicate *walker5Predicate = new WheelDistancePredicate(distance);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  FacingAngleMode famode = FA_WheelCount;
...
// スラローム位置補正。アームを下げたまま直進。
  ...
  distance = -3;
  Predicate *backPredicate = new WheelDistancePredicate(distance);
  ...
  WheelDistancePredicate *walkerCPredicate = new WheelDistancePredicate(distance);
  ...
  // 角度を調整する
  pwm = 5;
  FacingAngleAbs *facingAngle = new FacingAngleAbs(famode, pwm, slalomAngle);
  ...
  // 角度を調整する
  pwm = 7;
  FacingAngleAbs *facingAngleAbs = new FacingAngleAbs(famode, pwm, slalomAngle);
  commandExecutor->addCommand(facingAngle, new FinishedCommandPredicate(facingAngle), GET_VARIABLE_NAME(FacingAngle));
  ...
  r = 18;
  theta = 30;
  CurvatureWalkerCommandAndPredicate *curve1 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  // 角度を調整する
  pwm = 7;
  facingAngleAbs = new FacingAngleAbs(famode, pwm, slalomAngle);
  commandExecutor->addCommand(facingAngle, new FinishedCommandPredicate(facingAngle), GET_VARIABLE_NAME(FacingAngle));
  ...
  WheelDistancePredicate *walkerBPredicate = new WheelDistancePredicate(distance);
  ...
  r = 16;
  theta = 50;
  CurvatureWalkerCommandAndPredicate *curve2 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  WheelDistancePredicate *walkerQPredicate = new WheelDistancePredicate(distance);
  ...
  r = 8;
  theta = 50;
  CurvatureWalkerCommandAndPredicate *curve3 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  WheelDistancePredicate *walker6Predicate = new WheelDistancePredicate(distance);
  ...
  r = 10;
  theta = -45;
  CurvatureWalkerCommandAndPredicate *curve4 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  WheelDistancePredicate *walker7Predicate = new WheelDistancePredicate(distance);
  ...
  pwm = 10;
  angle = -85;
  RotateRobotUseGyroCommandAndPredicate *rotate4 = new RotateRobotUseGyroCommandAndPredicate(angle, pwm);
  ...
  WheelDistancePredicate *walker8Predicate = new WheelDistancePredicate(distance);
...
#endif
  angle = -90;
  RotateRobotUseGyroCommandAndPredicate *rotate5 = new RotateRobotUseGyroCommandAndPredicate(angle, pwm);
  ...
  r = 13.5;
  theta = 90;
  CurvatureWalkerCommandAndPredicate *curve5 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  ...
  WheelDistancePredicate *walker10Predicate = new WheelDistancePredicate(distance);
  commandExecutor->addCommand(walker10, walker10Predicate, GET_VARIABLE_NAME(walker10));

  // 45度右旋回
  pwm = 10;
  angle = 45;
  RotateRobotUseGyroCommandAndPredicate *rotate6 = new RotateRobotUseGyroCommandAndPredicate(angle, pwm);
  ...
  r = 10;
  theta = -65;
  CurvatureWalkerCommandAndPredicate *curve6 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  // PIDトレースで青線まで進む
  Predicate *distancePredicate = new WheelDistancePredicate(40);
...
// テールモータで角度をつける
  ...
  commandExecutor->addCommand(walker1_y, new WheelDistancePredicate(distance), GET_VARIABLE_NAME(walker1_y));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  radius = 16;
  theta = 50;
  CurvatureWalkerCommandAndPredicate *curve1 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve1->getCommand(), curve1->getPredicate(), GET_VARIABLE_NAME(curve1));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  WheelDistancePredicate *walkerAPredicate = new WheelDistancePredicate(distance );
  ...
  */
  ...
  radius = 18;
  theta = -30;
  CurvatureWalkerCommandAndPredicate *curve2 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve2->getCommand(), curve2->getPredicate(), GET_VARIABLE_NAME(curve2));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  radius = 15;
  theta = -35;
  CurvatureWalkerCommandAndPredicate *curve3 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve3->getCommand(), curve3->getPredicate(), GET_VARIABLE_NAME(curve3));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  WheelDistancePredicate *walkerDPredicate = new WheelDistancePredicate(distance);
  ...
  radius = 10;
  theta = 24;
  CurvatureWalkerCommandAndPredicate *curve4 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve4->getCommand(), curve4->getPredicate(), GET_VARIABLE_NAME(curve4));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  WheelDistancePredicate *walkerZPredicate = new WheelDistancePredicate(distance);
  ...
  radius = 14;
  theta = 55;
  CurvatureWalkerCommandAndPredicate *curveA = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  ...
  radius = 20;
  theta = -30;
  CurvatureWalkerCommandAndPredicate *curve5 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve5->getCommand(), curve5->getPredicate(), GET_VARIABLE_NAME(curve5));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  radius = 10;
  theta = -82.5;
  CurvatureWalkerCommandAndPredicate *curveD = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  ...
  radius = 33;
  theta = 70;
  CurvatureWalkerCommandAndPredicate *curve6 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  commandExecutor->addCommand(curve6->getCommand(), curve6->getPredicate(), GET_VARIABLE_NAME(curve6));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  */
  ...
  radius = 28;
  theta = 40;
  CurvatureWalkerCommandAndPredicate *curve7 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
  ...
  distance = 20;
  Walker *walker9 = new Walker(leftPWM, rightPWM);
  WheelDistancePredicate *walker9Predicate = new WheelDistancePredicate(distance);
  commandExecutor->addCommand(walker9, walker9Predicate, GET_VARIABLE_NAME(walker9));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  */
  ...
  WheelDistancePredicate *walker10yPredicate = new WheelDistancePredicate(distance );
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
...
#endif
  // PIDトレースから入る
  commandExecutor->addCommand(lowPWMTracer, new WheelDistancePredicate(5), GET_VARIABLE_NAME(pidTracer));
  ...
  // スラローム直前までPIDトレース
  float distance = 30;
  commandExecutor->addCommand(pidTracer, new WheelDistancePredicate(distance), GET_VARIABLE_NAME(pidTracer));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
...
// スラローム位置補正。アームを下げたまま直進。
  ...
  commandExecutor->addCommand(walker1, new WheelDistancePredicate(distance), GET_VARIABLE_NAME(walker1));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
  ...
  r = 18;
  theta = -80;
  CommandAndPredicate *curve1 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
  commandExecutor->addCommand(curve1->getCommand(), curve1->getPredicate(), GET_VARIABLE_NAME(curve1));
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  // スラローム直前までPIDトレース
  distance = 26;
  commandExecutor->addCommand(lowPWMTracer, new WheelDistancePredicate(distance), GET_VARIABLE_NAME(pidTracer));
  commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
...
// テールモータで角度をつける
  ...
  Predicate *walkerC2Predicate = new WheelDistancePredicate(6 );
  ...
  Predicate *walkerC3Predicate = new WheelDistancePredicate(6 );
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
...

  {
    ...
    // スラローム進入ここから
    {
      ...
      // PIDトレースで少し進む
      distance = 20;
      Predicate *distancePredicate = new WheelDistancePredicate(distance);
...
// 直進
      ...
      Predicate *walker5Predicate = new WheelDistancePredicate(distance);
      commandExecutor->addCommand(walker5, walker5Predicate, GET_VARIABLE_NAME(walker5));
      commandExecutor->addCommand(stopper, new NumberOfTimesPredicate(1), GET_VARIABLE_NAME(stopper));
#endif
#ifdef SlalomPattern2
      ...
      */
      ...
      WheelDistancePredicate *walker8yPredicate = new WheelDistancePredicate(distance );
      ...
      */
      ...
      radius = 18;
      theta = -30;
      CurvatureWalkerCommandAndPredicate *curve8 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
      ...
      radius = 18;
      theta = -360;
      CurvatureWalkerCommandAndPredicate *curve9 = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, radius, theta);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  WheelDistancePredicate *walkerPredicate = new WheelDistancePredicate(distanceCm);
  commandExecutor->addCommand(walker, walkerPredicate, GET_VARIABLE_NAME(walker));
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  float r = 30;
  float theta = 90;
  CurvatureWalkerCommandAndPredicate *commandAndPredicate = new CurvatureWalkerCommandAndPredicate(CWCMP_WheelCount, pwm, r, theta);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  // ACN度回転する
  RotateRobotCommandAndPredicate *turnACNCommandAndPredicate = new RotateRobotCommandAndPredicate(acn, pwm);
  ...
  WheelDistancePredicate *walkNCPredicate = new WheelDistancePredicate(nc);
  commandExecutor->addCommand(walkNCCommand, walkNCPredicate, GET_VARIABLE_NAME(walkNCCommand));

  // nTurn分旋回する
  RotateRobotCommandAndPredicate *turnNCommandAndPredicate = new RotateRobotCommandAndPredicate(nTurn, pwm);
  ...
  WheelDistancePredicate *walkNPredicate = new WheelDistancePredicate(n);
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  PIDTracer *pidTracer = new PIDLimTracer(RIGHT_TRACE, PLTM_PID_MOD, pwm, ku, tu, dt, r);
  commandExecutor->addCommand(pidTracer, new Predicate(), GET_VARIABLE_NAME(pidTracer));
  calibrator->addPIDTracer(pidTracer);
}
#endif
...
//#define SonarStarter
  ...
  // Predicate *predicate0 = new NumberOfTimesPredicate(4);
  Predicate *Kpredicate0 = new WheelDistancePredicate(Kdistance);
  ...
  Predicate *Kpredicate12 = new WheelDistancePredicate(26);
  commandExecutor->addCommand(Kwalker12, Kpredicate12, GET_VARIABLE_NAME(Kwalker12));
  Kpredicate12 = new WheelDistancePredicate(25);
  Predicate *KpredicateS12 = new WheelDistancePredicate(27);
  commandExecutor->addCommand(KwalkerS, KpredicateS12, GET_VARIABLE_NAME(KwalkerS));
  commandExecutor->addCommand(Kwalker12, Kpredicate12, GET_VARIABLE_NAME(Kwalker12));
  commandExecutor->addCommand(KwalkerS, Kpredicate11, GET_VARIABLE_NAME(KwalkerS));
  // IF１３コースに沿って直進
  Predicate *Kpredicate13S = new WheelDistancePredicate(155);
  ...
  Predicate *Kpredicate13 = new WheelDistancePredicate(7);
  commandExecutor->addCommand(Kwalker13, Kpredicate13, GET_VARIABLE_NAME(Kwalker13));
  Predicate *Kpredicate13S2 = new WheelDistancePredicate(20);
...
// ColorIDReaderModeの場合のcommandExecutor初期化処理
  ...
  */
  ...
  PIDTracer *waterMelonPIDTracer = new PIDTracer(RIGHT_TRACE, pwm, kp, ki, kd, dt);
  // Predicate *predicateWaterMelon = new WheelDistancePredicate(waterMelonDistance );
  Predicate *predicateWaterMelon = new ORPredicate(new WheelDistancePredicate(waterMelonDistance), new FacingRobotUseWheelPredicate(angle));
  calibrator->addPIDTracer(waterMelonPIDTracer);
  commandExecutor->addCommand(waterMelonPIDTracer, predicateWaterMelon, GET_VARIABLE_NAME(waterMelonPIDTracer));
...
// テールモータで角度をつける
  ...
  */
  ...
  Predicate *predicate1 = new WheelDistancePredicate(-18);
  ...
  rightPow = 20;
  Walker *walker3 = new Walker(leftPow, rightPow);
  Predicate *predicate3 = new WheelDistancePredicate(50);
  ...
  int *g = new int(30);
  int *b = new int(40);
  // Predicate *predicate8 = new WheelDistancePredicate(1 );
  //   int *r = new int(75);
  // int *g = new int(75);
  // int *b = new int(105);
  ...
  rightPow = 20;
  Walker *walker8 = new Walker(leftPow, rightPow);
  Predicate *predicate8w = new WheelDistancePredicate(5);
  ...
  rightPow = 20;
  Walker *walker10 = new Walker(leftPow, rightPow);
  Predicate *predicate10 = new WheelDistancePredicate(50);
  ...
  rightPow = 20;
  Walker *walker12 = new Walker(leftPow, rightPow);
  Predicate *predicate12 = new WheelDistancePredicate(11);
  commandExecutor->addCommand(walker12, predicate12, GET_VARIABLE_NAME(walker12));
  ...
  Predicate *predicate13S = new WheelDistancePredicate(1);
  for (int i = 0; i < 8; i++)
  {
...
#if defined(TrueCourceSanekataModeCS) | defined(TrueCourceSanekataMode1261b) | defined(TrueCourceOkiharaModeCSForKomichiRobot) | defined(TrueCourceOkiharaModeCSUseRegionalValueForKomichiRobot) | defined(TrueCourceOkiharaModeCSStableValueForOkiharaRobot) | defined(TrueCourceOkiharaModeCSForOkiharaRobot)
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  // wheelDiameter = 10.5; // これは実方機体
  // カラーセンサの乗ったアームの角度を調節する
...
// 直進
  ...
  if (true) // ガレージ
  {
    ...
    */
    ...
    rightPow = -15;
    Walker *walker1 = new Walker(leftPow, rightPow);
    Predicate *predicate1 = new WheelDistancePredicate(-19);
    commandExecutor->addCommand(walker1, predicate1, GET_VARIABLE_NAME(walker1));
    Stopper *stopper1 = new Stopper();
    Predicate *predicateS1 = new NumberOfTimesPredicate(1);
    commandExecutor->addCommand(stopper1, predicateS1, GET_VARIABLE_NAME(stoppper1));
    ...
    rightPow = 10;
    Walker *walker2 = new Walker(leftPow, rightPow);
    Predicate *predicate2 = new WheelDistancePredicate(-13);
    commandExecutor->addCommand(walker2, predicate2, GET_VARIABLE_NAME(walker2));
    // CommandAndPredicate *predicate2 = new RotateRobotUseGyroCommandAndPredicate(-91, 20 );
    // commandExecutor->addCommand(predicate2->getCommand(), predicate2->getPredicate(), GET_VARIABLE_NAME(predicate2->getCommand()));
    Stopper *stopper2 = new Stopper();
    Predicate *predicateS2 = new NumberOfTimesPredicate(1);
    commandExecutor->addCommand(stopper2, predicateS2, GET_VARIABLE_NAME(stoppper2));
    ...
    // Predicate *predicate4b = new WheelDistancePredicate(-5 );
    ...
    //    dt = 1;
    //    PIDTracer *bananaPIDTracer = new PIDTracer(RIGHT_TRACE, pwm, kp, ki, kd, dt);
    //    Predicate *predicateBanana = new WheelDistancePredicate(20 );
    //    commandExecutor->addCommand(bananaPIDTracer, predicateBanana, GET_VARIABLE_NAME(bananaPIDTracer));
    //    calibrator->addPIDTracer(bananaPIDTracer);
    Predicate *predicateCarrot = new WheelDistancePredicate(10);
    //指定距離IPD
    ...
    rightPow = 20;
    Walker *walker8 = new Walker(leftPow, rightPow);
    Predicate *predicate8w = new WheelDistancePredicate(11);
    commandExecutor->addCommand(walker8, predicate8w, GET_VARIABLE_NAME(walker8));
    commandExecutor->addCommand(stopper8, predicateS8, GET_VARIABLE_NAME(stoppper8));
    // 9，左に旋回する。
    leftPow = -5;
    ...
    rightPow = 20;
    Walker *walker10 = new Walker(leftPow, rightPow);
    Predicate *predicate10 = new WheelDistancePredicate(15);
    commandExecutor->addCommand(walker10, predicate10, GET_VARIABLE_NAME(walker10));
    ...
    //青の後ちょっと進む
    //  Predicate *predicate10bl = new WheelDistancePredicate(10 );
    ...
    rightPow = 20;
    Walker *walker12 = new Walker(leftPow, rightPow);
    Predicate *predicate12 = new WheelDistancePredicate(27);
    commandExecutor->addCommand(walker12, predicate12, GET_VARIABLE_NAME(walker12));
    Walker *walker12b = new Walker(leftPow, rightPow);
    ...
    if (useFacingAngle0) // FacingAngleによるガレージイン
    {
      ...
      Predicate *straightWalkerPredicate = new WheelDistancePredicate(distance);
    ...
    else // 青トレースによるガレージイン
    {
      ...
      else
      {
        ...
        rightPow = -10;
        Walker *walker2 = new Walker(leftPow, rightPow);
        Predicate *predicate2 = new WheelDistancePredicate(10);
        commandExecutor->addCommand(walker2, predicate2, GET_VARIABLE_NAME(walker2));
      }
      ...
      Predicate *predicate13blue = new WheelDistancePredicate(15);
...
#if defined(TrueCourceSanekataModeSimurator)
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  // wheelDiameter = 10.5; // これは実方機体
  // カラーセンサの乗ったアームの角度を調節する
...
// ↓ここから沖原↓
...
#endif
  {
    ...
    float starFruitsDistance = 5 * coefficientDistance; // CS 5 // 12;
...
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  ...
  Predicate *walker1ysPredicate = new WheelDistancePredicate(distance);
  ...
  Predicate *walker2ysPredicate = new WheelDistancePredicate(distance);
  ...
  Predicate *walker3ysPredicate = new WheelDistancePredicate(distance);
  commandExecutor->addCommand(walker3ys, walker3ysPredicate, GET_VARIABLE_NAME(walker3ys));

  pwm = basePWM * coefficientCurvePWM;
  radius = 28;
  theta = -170;
  CommandAndPredicate *curve3ys = new CurvatureWalkerCommandAndPredicate(curveMode, pwm, radius, theta);
  ...
  Predicate *walker4ysPredicate = new WheelDistancePredicate(distance);
  commandExecutor->addCommand(walker4ys, walker4ysPredicate, GET_VARIABLE_NAME(walker4ys));

  pwm = basePWM * coefficientCurvePWM;
  radius = 45;
  theta = 320;
  CommandAndPredicate *curve4ys = new CurvatureWalkerCommandAndPredicate(curveMode, pwm, radius, theta);
  ...
  Predicate *walker5ysPredicate = new WheelDistancePredicate(distance);
  ...
  Predicate *walker6ysPredicate = new WheelDistancePredicate(distance);
  ...
  Predicate *walker7ysPredicate = new WheelDistancePredicate(distance);
  ...
  Predicate *walker8ysPredicate = new WheelDistancePredicate(distance);
