...
#if defined(TrueCourceSanekataModeCS) | defined(TrueCourceOkiharaModeCSForKomichiRobot) | defined(TrueCourceOkiharaModeCSUseRegionalValueForKomichiRobot) | defined(TrueCourceOkiharaModeCSStableValueForOkiharaRobot)
void initializeCommandExecutor(CommandExecutor *commandExecutor, RobotAPI *robotAPI)
{
  // wheelDiameter = 10.5; // これは実方機体
  // カラーセンサの乗ったアームの角度を調節する
